      ...
      <div className="min-h-screen bg-background pb-20 lg:pb-8">
        <div className="container mx-auto px-4 py-8 max-w-3xl">
          <div className="mb-8">
            ...
            <p className="text-muted">Hier vind je de locaties waar we voetballen</p>
          </div>
          ...
          <div className="mt-8 p-6 bg-accent/10 rounded-xl border border-accent/20">
            ...
            <p className="text-muted">
              Klik op &quot;Navigeer naar locatie&quot; om de locatie te openen in je favoriete navigatie-app.
              Je kunt kiezen uit Google Maps, Apple Maps, Waze en meer!
            </p>
          </div>
        </div>
      </div>

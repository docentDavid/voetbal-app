        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted">Bekijk en meld je aan voor aankomende speeldagen</p>
            </div>
          ...
          {matchDays.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h2 className="text-2xl font-semibold mb-2">Geen speeldagen gepland</h2>
              <p className="text-muted mb-6">Maak de eerste speeldag aan!</p>
              <CreateMatchDayButton />
            </div>
          ) : (

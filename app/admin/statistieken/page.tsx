      ...
      <div className="min-h-screen bg-gray-50 pb-20 lg:pb-8">
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Wie heeft er gevoetbald en waar?</p>
            <p className="text-sm text-gray-600 mt-2">
              ℹ️ Alleen afgelopen speeldagen tellen mee (geen geannuleerde
              dagen)
            </p>
          </div>
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">Gespeelde dagen</div>
                  </div>
                </CardContent>
              </Card>
                      ...
                      <div key={location.id}>
                        ...
                        <div className="w-full bg-border rounded-full h-2 overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${
                                (location.count / stats.totalMatchDays) * 100
                              }%`,
                            }}
                          />
                        </div>
